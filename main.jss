...
(function(window){
    var Game ={
        ...
        gameOver: function(){
            ...
            this.ctx.fillText(message2, this.c.width /2 - this.ctx.measureText(message).width / 2, this.c.height / 2 - 5);
            this.ctx.font = "bold 16px Lato, sans-serif";
            this.ctx.fillText(message3, this.c.width /2 - this.ctx.measureText(message).width / 2, this.c.height / 2 - 30);
        },
        ...
        loop: function(){
            if(!Game.paused){
                ...
                for(var i in Game.enemies){
                    ...
                    currentEnemy.draw();
                    currentEnemy.update();
                    if(Game.currentFrame % currentEnemy.shooting === 0){
                        currentEnemy.shoot();
                    }
                }
   ...
   Player.prototype.shoot = function(){
       Game.bullet[Game.bulletIndex] = new Bullet(this.x + this.width / 2);
       Game.bulletIndex++;
   };
   ...
   Bullet.prototype.draw = function(){
    ...
    EnemyBullet.prototype.draw =function(){
       Game.ctx.fillStyle = thsi.color;
       Game.ctx.fillRect(this.x, this.y,this.width, thsi.height);
    };
    ...
    var Particle = function(x,y,color){
        ...
        Game.particles[Game.particlesIndex] = this;
